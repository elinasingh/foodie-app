       ...
       // configure krna
			 foodieApp.config(function ($routeProvider) { //pass function as parameter
				...
				.when('/home',{
					templateUrl: 'pages/main.html',    //main url
					controller: 'mainController'
				})
				.when('/restaurant/:id', {
		      templateUrl: 'pages/restaurant.html',   //restaurant url
		      controller: 'restaurantController'
	       })
				 .when('/fav', {
						templateUrl: 'pages/fav.html',       //fav url
  ...
  //iss function ke andar jo b aayega bhi kaam hoga controller ka
					 ...
					 foodieApp.controller('restaurantController',function($scope,$routeParams,$http,$location) {
						 $scope.ingredients = [];
							...
							{                           //restaurant 2
								...
								bestDish: {
										name: 'Noodles',
										image: 'http://freedesignfile.com/upload/2016/12/Tasty-Chinese-Food-HD-picture-03.jpg'
									},
								votes:'200',
								reviews:'300',
								order:'60mins Rs.80',
							...
							{                               //restaurant 3
								...
								bestDish: {
										name: 'pie cake',
										image: 'http://data.freehdw.com/multicolor-food-donuts-hd-background.jpg'
									},
								votes:'190',
								reviews:'250',
								order:'50mins Rs.70',
							...
							{                                 //restaurant 4
								...
								bestDish: {
										name: 'stake',
										image: 'http://photo.elsoar.com/wp-content/images/Meat-And-Vegetable-Salad-Wallpaper-Hd.jpg'
									},
								votes:'150',
								reviews:'280',
								order:  '20mins Rs.100',
							...
							{                                 //restaurant 5
								...
								bestDish: {
										name: 'Burger',
										image: 'http://cdn.wallpapersafari.com/93/11/2g9Mch.jpg'
									},
								votes:'280',
								reviews:'400',
								order:'70mins Rs.30',
							...
							{                                   //restaurant 6
								...
								bestDish: {
										name: 'Mexicon food',
										image: 'http://cdn.wallpapersafari.com/0/57/sq0MY5.jpg'
									},
								votes:'120',
								reviews:'300',
								order:'90mins Rs.80',
							...
							{                               //restaurant 7
								...
								bestDish: {
										name: 'Donates',
										image: 'https://foodanddrinkshdwallpapers.files.wordpress.com/2014/10/french_breakfast.jpg'
									},
								votes:'180',
								reviews:'600',
								order:'70mins Rs.50',
							...
							{                                  //restaurant 8
								...
								bestDish: {
										name: 'Sweets',
										image: 'http://bsnscb.com/data/out/191/38899161-sweets-wallpapers.jpg'
									},
								votes:'170',
								reviews:'500',
								order:'50mins Rs.80',
              ...
              //write ajax call here
                         ...
                         var list ='';
										...
										$scope.goToFav = function() {       //goto fav function
												$location.url('fav')
...
//console.log($routeParams.id);
  ...
  $scope.restaurants = [{   //dishes for favorite food that you like or not
         ...
         //list1 for you may like OR NOT
					...
					//list2 for you may LIKE OR NOT like
					$scope.lists2 = [
					{'vl' : 'meat'},
					{'vl' : 'egg'},
					{'vl' : 'onion'},
				...
				$scope.getFav = function(url) {
						var data = '{"inputs":[{"data":{"image":{"url":"' + url + '"}}}]}'
										$http({                                                        //api call
											...
											'headers': {
												'Authorization': 'Key fe486afe04fe4bf9a1fec63b55d9f8cb',              //api key
												'Content-Type': 'application/json'
											},
											'data': data,

										}).then(function (response) {     //fav food helper code
